                    ...
                    <form action="{{ route('alumnos.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                                <p class="text-xs text-indigo-600 mt-1">Este será el usuario para acceder a la plataforma.</p>
                            </div>

                            <div>
                                <label for="matricula" class="block text-sm font-medium text-gray-700">Matrícula <span class="text-red-500">*</span></label>
                                <input type="text" name="matricula" id="matricula" value="{{ old('matricula') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                                <p class="text-xs text-indigo-600 mt-1">Esta será la contraseña inicial asignada.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="nivel" name="nivel" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                                    ...
                                    <option value="b1" {{ old('nivel') == 'b1' ? 'selected' : '' }}>B1 - Intermedio</option>
                                    <option value="b2" {{ old('nivel') == 'b2' ? 'selected' : '' }}>B2 - Intermedio Alto</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                            </div>

                            <div>
                                <label for="apellidos" class="block text-sm font-medium text-gray-700">Apellidos <span class="text-red-500">*</span></label>
                                <input type="text" name="apellidos" id="apellidos" value="{{ old('apellidos') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="telefono" id="telefono" value="{{ old('telefono') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                            </div>

                            <div>
                                <label for="fecha_inscripcion" class="block text-sm font-medium text-gray-700">Fecha de Inscripción</label>
                                <input type="date" name="fecha_inscripcion" id="fecha_inscripcion" value="{{ old('fecha_inscripcion') ?? date('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 focus:bg-white transition">
                            </div>
                            ...
                            <div class="md:col-span-2 mt-2 bg-gray-50 p-4 rounded border border-gray-200">
                                <div class="flex items-start">
                                    <div class="flex h-5 items-center">
                                        <input id="activo" name="activo" type="checkbox" value="1" {{ old('activo', 1) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer">
                                    </div>
                        ...
                        <div class="mt-8 pt-5 border-t border-gray-200 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="bg-indigo-600 border border-transparent rounded-md shadow-sm py-2 px-8 inline-flex justify-center text-sm font-bold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition">
                                Guardar Alumno
                            </button>
                        </div>
                    </form>
